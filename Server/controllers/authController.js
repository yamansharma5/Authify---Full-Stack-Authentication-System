...
// The logout function clears the authentication token cookie from the user's browser, effectively logging the user out of the application.
...
export const verifyResetPasswordOtp = async (req, res) => {
    ...
    try {
        ...
        console.error("verifyResetPasswordOtp error:", error.message);
        return res.json({ success: false, error: error.message, message: "Internal Server Error" });
    }
}
